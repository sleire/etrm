##############################################################################
# Dynamic Proportion Portfolio Insurance strategy (DPPI)
# Q       - quantity to be hedged
# P       - price vector
# tper    - target price markup - ex 1.2 = 120% of min{portf price}
# RF      - risk factor vector
...
dppiHedge<-function (Q,P,tper=1.15,RF=10,tcost=0,min=Q,integer=TRUE){
